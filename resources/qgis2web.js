...
map.getView().fit([1863833.534260, -4156309.930796, 2809331.972564, -3544770.458330], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">CDC vs CPS-HPSR</h2>';
        return titleElement;
    })(),
